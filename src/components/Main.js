    ...
    return (
        <motion.div className='flex flex-col self-center pt-20 md:mx-12 md:max-w-3xl '>
            ...
            <motion.div
                ...
                className='pt-20 md:pt-6 text-subHeading text-2xl md:text-5xl leading-8 md:leading-normal tracking-wider'
            >
                <p>
                    My name is{' '}
            ...
            <motion.div
                ...
                className='flex justify-between text-lightBlack dark:text-offWhite border border-lightBlack dark:border-offWhite rounded-full py-6 px-10 mt-64 md:mt-36 hover:scale-102 transition ease-out duration-300 group hover:border-violet-300'
            >
